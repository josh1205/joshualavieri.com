...
export const ui = {
  en: {
    ...
    'sidebar.notTranslated': 'This page is not translated',
    'sidebar.theme': 'Theme',
    'footer.builtWith': 'Built with Astro. Hosted on Cloudflare. Managed by Pulumi.',
    'footer.designCredit': 'Design inspired by',
    'home.greeting': "Hey, I'm Josh!",
    'home.tagline': 'Infrastructure/platform engineer, software enthusiast, ',
    'home.afrikaner': 'part time afrikaner',
    'home.afrikanerTip': 'Person learning afrikaans (language from South Africa)',
  ...
  af: {
    ...
    // 'sidebar.notTranslated': 'This page is not translated yet',
    'sidebar.notTranslated': 'Hierdie bladsy is nie vertaal nie',
    'sidebar.theme': 'Tema',
    'footer.builtWith': 'Gebou met Astro. Aangebied op Cloudflare. Bestuur met Pulumi.',
    'footer.designCredit': 'Ontwerp geïnspireer deur',
    'home.greeting': 'Haai, ek is Josh!',
    'home.tagline': 'Infrastruktuur-/platformingenieur, software enthusiast, ',
    'home.afrikaner': 'deeltydse Afrikaner',
    'home.afrikanerTip': 'Persoon leer Suid-Afrika (taal van Suid Afrika',
...
export const timeline = {
  ...
  af: [
    ...
    {
      range: '2018–2022',
      html: "<a href=\"/me/\">Neurowetenskap na CS</a>: halfpad deur my neurowetenskap graad, een Intro to Software Engineering klas het die plan verander. Ek het my hoofvak verander en elke engineering klas geneem wat ek kon.",
    },
    {
      range: '2021–2025',
